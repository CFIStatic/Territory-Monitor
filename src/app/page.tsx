...
import { ArrowRight, CloudLightning, CreditCard, MapPinned, Timer } from "lucide-react";
    ...
    <div className="min-h-screen">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-6xl flex-col px-6 py-8">
          <header className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/login"
                className="btn btn-ghost border-white/20 bg-white/5 text-white hover:bg-white/10"
              >
                Sign in
              </Link>
              <Link href="/signup" className="btn btn-signal">
                Get started
              </Link>
            </div>
          </header>
          ...
          <div className="flex flex-1 flex-col justify-center pb-16 pt-20">
            ...
            <p className="fade-up-delay mt-5 max-w-xl text-lg leading-relaxed text-white/75">
              Event-driven email outreach for restoration sales — create an account, connect Stripe,
              upload contacts, and reach the right homeowners before the storm arrives.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <p className="mt-3 max-w-2xl text-ink/60">
          From account setup and Stripe billing through weather-timed outreach, one workspace for
          restoration agents.
        </p>
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-4">
          <div>
            ...
            <h3 className="mt-3 font-display text-xl text-ink">Account + Stripe</h3>
            <p className="mt-2 text-sm leading-relaxed text-ink/60">
              Sign up, set company identity, and activate billing with Stripe Checkout or demo mode.
            </p>
          </div>
          <div>
